...
TSharedPtr< FSlateStyleSet > FProjectJGameEditorStyle::StyleInstance = nullptr;

void FProjectJGameEditorStyle::Initialize()
{
...
void FProjectJGameEditorStyle::Shutdown()
{
...
FName FProjectJGameEditorStyle::GetStyleSetName()
{
...
TSharedRef< FSlateStyleSet > FProjectJGameEditorStyle::Create()
{
	TSharedRef<FSlateStyleSet> StyleRef = MakeShareable(new FSlateStyleSet(FProjectJGameEditorStyle::GetStyleSetName()));
...
const ISlateStyle& FProjectJGameEditorStyle::Get()
{
